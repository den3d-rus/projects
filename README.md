...
|[Маркетинговая аналитика Яндекс.Афиши](project_spr07.ipynb)|**Цель**: снизить расходы

**Задача**: определить неэффективные истоники трафика.

**Изучить**: как клиенты пользуются сервисом, когда делают первые покупки на сайте, сколько денег приносит компании каждый клиент, когда расходы на привлечение клиента окупаются.|*pandas , numpy , seaborn, matplotlib*|
|[Аналитика в авиакомпании ](project_spr06.ipynb)|У нас есть 2 набора данных, полученных ранее в процессе работы с БД, необходимо:

  - выбрать топ-10 городов по количеству рейсов;
  - построить графики: модели самолетов и количество рейсов, города и количество рейсов, топ-10 городов и количество рейсов;
  - сделать выводы по каждому из графиков, пояснить результат.|*pandas , seaborn, matplotlib*|
